      ...
      <main className="mx-auto max-w-7xl px-4 py-28 sm:px-6 lg:px-8">
        <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
          ...
          {isSeller && (
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-blue-600 to-rose-500 px-5 py-2.5 text-sm font-semibold text-white shadow-md transition hover:opacity-95"
            >
        ...
        {isSeller && !error && products.length === 0 && (
          <div className="rounded-2xl border border-dashed border-border bg-card p-12 text-center">
            ...
            <Link
              to="/dashboard/listings/new"
              className="mt-5 inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-blue-600 to-rose-500 px-5 py-2.5 text-sm font-semibold text-white shadow-md transition hover:opacity-95"
            >
              <Plus className="h-4 w-4" />
