        ...
        <div className="flex flex-col lg:flex-row gap-4 mb-8">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 rounded-xl border border-input bg-background text-foreground outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`p-2 rounded-lg transition ${viewMode === 'grid' ? 'bg-blue-500 text-white' : 'bg-muted text-muted-foreground'}`}
            >
              <Grid className="w-5 h-5" />
            </button>
            <button
              onClick={() => setViewMode('list')}
              className={`p-2 rounded-lg transition ${viewMode === 'list' ? 'bg-blue-500 text-white' : 'bg-muted text-muted-foreground'}`}
            >
            ...
            >
              <div className="relative aspect-square overflow-hidden bg-muted">
                ...
                <div className="absolute inset-x-3 bottom-3 flex translate-y-4 gap-2 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
                  <Button
                    size="sm"
                    className="flex-1 rounded-full bg-gradient-to-r from-blue-500 to-blue-700 text-white"
                  >
