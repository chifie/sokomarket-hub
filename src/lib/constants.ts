...
export const sellers: Seller[] = [
  ...
  { id: "seller-6", name: "Peter Kimani", storeName: "SportZone TZ",
    ...
    banner: "https://images.unsplash.com/photo-1517466787929-bc90951d0974?w=1200&q=80",
...
export const banners: Banner[] = [
  { id: "b1", title: "Premium Tech Deals", subtitle: "Up to 40% Off", description: "Latest smartphones, laptops, and gadgets at unbeatable prices", cta: "Shop Tech Deals", link: "/marketplace?category=electronics", desktopImage: "https://images.unsplash.com/photo-1468495244123-6c6c332eeece?w=1920&q=80", mobileImage: "https://images.unsplash.com/photo-1468495244123-6c6c332eeece?w=600&q=80", badge: "Limited Time", discount: 40, type: "hero", priority: 1, isActive: true, startDate: new Date().toISOString(), endDate: new Date(Date.now() + 14 * 24 * 60 * 60 * 1000).toISOString() },
  { id: "b2", title: "Tanzanian Fashion Collection", subtitle: "Discover Local Designers", description: "Authentic Tanzanian fashion from top local designers", cta: "Explore Fashion", link: "/marketplace?category=fashion", desktopImage: "https://images.unsplash.com/photo-1445205170230-053b83016050?w=1920&q=80", mobileImage: "https://images.unsplash.com/photo-1445205170230-053b83016050?w=600&q=80", badge: "New Collection", discount: 25, type: "hero", priority: 2, isActive: true, startDate: new Date().toISOString(), endDate: new Date(Date.now() + 30 * 24 * 60 * 60 * 1000).toISOString() },
  { id: "b3", title: "Free Delivery Week", subtitle: "Nationwide — TZ Mainland & Zanzibar", description: "Enjoy free delivery on all orders across Tanzania", cta: "Start Shopping", link: "/marketplace", desktopImage: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=1920&q=80", mobileImage: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=600&q=80", badge: "Free Delivery", type: "hero", priority: 3, isActive: true, startDate: new Date().toISOString(), endDate: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toISOString() },
  { id: "b4", title: "SokoDigital Ramadan Sale", subtitle: "Blessings & Savings", description: "Special Ramadan offers on groceries, fashion, and home essentials", cta: "Shop Ramadan Deals", link: "/marketplace?category=groceries", desktopImage: "https://images.unsplash.com/photo-1542838132-92c53300491e?w=1920&q=80", mobileImage: "https://images.unsplash.com/photo-1542838132-92c53300491e?w=600&q=80", badge: "Ramadan Special", discount: 30, type: "hero", priority: 4, isActive: true, startDate: new Date().toISOString(), endDate: new Date(Date.now() + 21 * 24 * 60 * 60 * 1000).toISOString() },
  { id: "b5", title: "Student Discount Week", subtitle: "Save Big on Essentials", description: "Verified students get up to 50% off on laptops, books, and stationery", cta: "Student Deals", link: "/marketplace?category=computers", desktopImage: "https://images.unsplash.com/photo-1523050854058-8df90110c7f1?w=1920&q=80", mobileImage: "https://images.unsplash.com/photo-1523050854058-8df90110c7f1?w=600&q=80", badge: "Students Only", discount: 50, type: "hero", priority: 5, isActive: true, startDate: new Date().toISOString(), endDate: new Date(Date.now() + 14 * 24 * 60 * 60 * 1000).toISOString() },
];
