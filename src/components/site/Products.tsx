            ...
            >
              <div className="relative aspect-square overflow-hidden bg-muted">
                ...
                <div className="absolute inset-x-3 bottom-3 flex translate-y-4 gap-2 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
                  <button className="flex-1 rounded-full bg-gradient-to-r from-indigo-600 to-indigo-800 text-white text-sm font-medium px-3 py-1.5 inline-flex items-center justify-center">
