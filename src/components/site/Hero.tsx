...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-teal-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 pt-28 pb-20 lg:pt-36 lg:pb-28">
      {/* animated blobs */}
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute -left-24 top-24 h-96 w-96 rounded-full bg-blue-400/20 dark:bg-blue-600/20 blur-3xl animate-pulse" />
        <div className="absolute right-0 top-1/3 h-96 w-96 rounded-full bg-blue-400/20 dark:bg-blue-700/20 blur-3xl" />
        <div className="absolute bottom-0 left-1/3 h-72 w-72 rounded-full bg-rose-400/20 dark:bg-rose-500/20 blur-3xl" />
      </div>
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
        ...
        >
          <span className="inline-flex items-center gap-2 rounded-full border border-blue-500/20 bg-blue-500/10 dark:bg-blue-500/20 px-3 py-1 text-xs font-semibold text-blue-600 dark:text-blue-400">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              to="/marketplace"
              className="h-12 rounded-full bg-gradient-to-r from-blue-500 to-blue-700 px-6 text-base font-semibold text-white shadow-md transition hover:scale-[1.02] hover:opacity-95 inline-flex items-center justify-center"
            >
          ...
          <div className="mt-10 grid max-w-lg grid-cols-2 gap-3 sm:grid-cols-4">
            {[
              ...
              >
                <b.icon className="h-4 w-4 shrink-0 text-blue-500" />
        ...
        >
          <div className="relative mx-auto aspect-square w-full max-w-[500px] overflow-hidden rounded-[2rem] shadow-xl">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/40 via-transparent to-blue-400/30" />
          </div>
