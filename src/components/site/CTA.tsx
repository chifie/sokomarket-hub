...
export function CTA() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-r from-emerald-500 to-teal-600 py-24 text-white">
      ...
      >
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <Link
            to="/marketplace"
            className="h-12 rounded-full bg-white px-8 font-semibold text-emerald-600 inline-flex items-center justify-center hover:bg-white/90 transition"
          >
            Shop Now
          </Link>
          <button
