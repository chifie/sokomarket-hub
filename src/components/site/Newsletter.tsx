  ...
  return (
    <section className="py-20 lg:py-28">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="pointer-events-none absolute -right-16 -top-16 h-72 w-72 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 opacity-20 blur-3xl" />
          ...
          <div className="relative grid grid-cols-1 items-center gap-8 lg:grid-cols-2">
            ...
            >
              <input
                ...
                className="h-12 flex-1 rounded-full border border-border bg-background px-5 text-sm outline-none transition focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 text-foreground"
              />
              <button
                type="submit"
                className="h-12 rounded-full bg-gradient-to-r from-emerald-500 to-teal-600 px-6 font-semibold text-white shadow-md hover:opacity-95 transition inline-flex items-center justify-center"
              >
