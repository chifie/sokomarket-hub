...
import { Search, Sparkles, TrendingUp, Shield, Zap, ArrowRight } from "lucide-react";
      ...
      <div className="relative mx-auto max-w-7xl px-4 pt-16 pb-20 md:pt-24 md:pb-28">
        <div className="flex flex-col items-center text-center">
          ...
          >
            <Badge
              variant="outline"
              className="mb-6 px-4 py-1.5 rounded-full border-primary/20 bg-primary/5 text-primary text-xs font-medium gap-1.5"
            >
              <Sparkles className="h-3 w-3" />
              AI-Powered Marketplace
              <span className="text-muted-foreground/60 mx-1">•</span>
              <span className="text-muted-foreground">Trusted by 2.5M+ buyers</span>
            </Badge>
          </motion.div>
          ...
          >
            Africa's premier AI-powered marketplace. Find verified sellers, discover unique products, 
            and shop with confidence — all powered by intelligent recommendations.
          </motion.p>
          ...
          >
            <div className="relative group">
              ...
              <div className="relative flex items-center bg-card border border-border/50 rounded-2xl shadow-lg shadow-primary/5 group-hover:shadow-xl transition-all duration-300">
                ...
                <Button
                  size="lg"
                  className="mr-2 h-10 rounded-xl bg-primary hover:bg-primary/90 text-sm font-medium gap-1.5 shadow-sm"
                >
          ...
          >
            ...
            {trendingCategories.map((cat) => (
              <button
                key={cat}
                className="rounded-full border border-border/50 bg-muted/30 px-3.5 py-1.5 text-xs font-medium text-muted-foreground hover:bg-primary/5 hover:text-primary hover:border-primary/20 transition-all duration-200"
              >
                {cat}
              </button>
            ))}
          ...
          >
            <Button size="lg" className="rounded-full h-12 px-8 text-sm font-medium shadow-lg shadow-primary/20">
              Start Shopping
