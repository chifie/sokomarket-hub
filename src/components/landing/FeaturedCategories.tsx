    ...
    <section className="py-16 md:py-20">
      <div className="mx-auto max-w-7xl px-4">
        <div className="flex items-center justify-between mb-10">
          ...
          <Link to="/marketplace">
            <Button variant="ghost" size="sm" className="text-sm gap-1.5 rounded-full cursor-pointer">
            ...
            return (
              ...
              >
                <Link
                  ...
                  className="group relative overflow-hidden rounded-2xl border border-border/50 bg-card p-6 hover:shadow-lg hover:shadow-primary/5 transition-all duration-300 hover:-translate-y-0.5 block"
                >
