...
import { Mail, Send, Bell, ShoppingBag, Gift, Check } from "lucide-react";
    ...
    <section className="py-16 md:py-20">
      <div className="mx-auto max-w-7xl px-4">
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative overflow-hidden rounded-3xl border border-border/50 bg-card p-8 md:p-12 premium-shadow"
        >
          ...
          <div className="relative flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-muted-foreground mt-2 text-sm max-w-md mx-auto lg:mx-0">
            ...
            <div className="w-full max-w-md">
              <form onSubmit={handleSubmit}>
                <div className="flex gap-2">
                  ...
                  <Button
                    type="submit"
                    className={cn(
                      "h-12 rounded-xl px-6 gap-1.5 shadow-sm transition-all duration-300",
              ...
              <p className="text-[11px] text-muted-foreground mt-3 text-center lg:text-left">
