        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-white/60 leading-relaxed mb-6">
              Africa's premier AI-powered marketplace connecting buyers and sellers across the continent. Shop smart, sell global.
            </p>
            ...
            <div className="flex items-center gap-3 mt-6">
              {[Facebook, Twitter, Instagram, Youtube, Linkedin].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="h-9 w-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-primary transition-all duration-200 hover:scale-110"
                >
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-sm text-white/60 mt-1">
                Get exclusive deals, new arrivals, and seller tips.
              </p>
            </div>
            <div className="flex w-full max-w-md gap-2">
              <Input
                ...
                className="h-11 bg-white/10 border-white/20 text-white placeholder:text-white/40 rounded-full focus-visible:ring-primary/50"
              />
              <Button className="h-11 rounded-full px-6 bg-primary hover:bg-primary/90 shadow-lg">
                Subscribe
              </Button>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex gap-1">
              {["Visa", "MC", "MPesa", "Airtel"].map((p) => (
                <span key={p} className="px-2 py-0.5 bg-white/10 rounded text-[10px] font-medium text-white/60">
                  {p}
                </span>
              ))}
            </div>
